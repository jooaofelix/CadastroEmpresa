...
Abra `ficha-cnpj.html` diretamente no navegador (não precisa de servidor nem
...
Por ser um único arquivo estático, `ficha-cnpj.html` pode ser hospedado em
qualquer serviço de páginas estáticas (GitHub Pages, Netlify, Vercel etc.)
